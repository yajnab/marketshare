 ...
 * @author Yajnavalkya Bandyopadhyay, 2nd Year(2016), Techno India College of
 * Technology
 */
...
public class Marketshare {
        ...
        public void run() {
            int k=1;try {
                do {
                    ...
                    //genFile gn = new genFile();
                    //gn.GenFile(content);
                    System.out.println(content);
                    //insert_item(content);
                    k++;
                    //remainder section
                } while (k<2); // 100 is upper bound, to remove infinite looping
            } catch (Exception ex) {
                ex.printStackTrace();
            }
    ...
    public Marketshare(WebClient webclient) throws IOException, Exception {
       ...
       // new shareproducer(webclient).start(); //start process i
        ...
        //create_porfolio cp = new create_porfolio();
        //cp.make_portfolio(webclient);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("in yajnab main");
            //create_porfolio cp = new create_porfolio();
            //cp.make_portfolio(webClient);
